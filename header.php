...
<body>
<div id="menu">
     <a class="item" href="/IWP Project 2/index.php">Home</a> 
      
     <?php
     if(isset($_SESSION['signed_in']) && $_SESSION['signed_in'] && $_SESSION['user_level']==1)
     {
	     echo '<a class="item" href="/IWP Project 2/add_admin.php">Add admin</a>';
	     echo '<a class="item" href="/IWP Project 2/create_cat.php">Create new category</a>';
     }
